...
class VSCodeExtensionBackend:
    ...
    def handle_request(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if command == 'chat':
                ...
                return self.handle_get_status(params)
            else:
                return {
                    'success': False,
            ...
            if file_type == 'pdf':
                ...
                if text:
                    return {
                        ...
                        'content': text,
                        'length': len(text),
                        'summary': self._generate_summary(text) if self.ai_initialized else None
                    }
                ...
                if code:
                    ...
                    is_valid = self.code_processor.validate_syntax(code, language)
                    ...
                    return {
                        ...
                        'analysis': self._analyze_code(code, language) if self.ai_initialized else None
                    }
    ...
    def handle_generate_code(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                'success': False,
                'error': f'Error generating code: {e}'
            }
    ...
    def handle_analyze_code(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            language = params.get('language', 'python')
            analysis_type = params.get('analysis_type', 'general')  # general, security, performance, style
...
class VSCodeCommunicator:
    ...
    def start_server(self, port: int = 8765):
        ...
        try:
            ...
            self.logger.info(f"Starting VS Code communication server on port {port}")
            self.listen_stdin()
        except Exception as e:
...
def main():
    ...
    parser.add_argument('--mode', choices=['server', 'stdin'], default='stdin',
