...
class CustomAIModel(BaseAI):
    ...
    def __init__(self, conversation_memory: ConversationMemory = None):
        ...
        self.identity_responses = {
            ...
            "detailed": [
                "Je suis Assistant IA Local, version 4.2.0 Je suis un modèle d'intelligence artificielle conçu pour fonctionner entièrement en local, sans dépendance externe. Je peux générer du code, expliquer des concepts, et avoir des conversations naturelles avec vous.",
