...
echo [6/10] Suppression de ultra_context.db...
...
echo [7/10] Suppression de code_cache.json...
...
echo [8/10] Suppression de web_search_cache.db...
...
echo [9/10] Suppression complete du contenu de chroma_db...
