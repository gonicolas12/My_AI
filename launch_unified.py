#!/usr/bin/env python3
"""
🚀 MY PERSONAL AI - LAUNCHER UNIFIÉ v5.0
...
def main():
    ...
    print("🚀 MY PERSONAL AI LAUNCHER UNIFIÉ v5.0")
    print("=" * 50)
    ...
    try:
        ...
        print("   python -c \"from interfaces.gui_modern import ModernAIGUI; ModernAIGUI().run()\"")
        sys.exit(1)
