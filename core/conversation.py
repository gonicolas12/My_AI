...
class ConversationManager:
    ...
    def __init__(self, max_history: int = 10, memory: Optional[Any] = None):
        ...
        self.memory = memory
        self._simple_history: List[Dict[str, str]] = (
            []
        )  # Pour compatibilité avec add_message/get_history
    ...
    def add_exchange(
        self, user_input: str, ai_response: Union[str, Dict[str, Any]]
    ) -> None:
        """
    ...
    def save_session(self, filepath: str) -> None:
        ...
        """
        session_data = {"session": self.current_session, "history": self.history}
