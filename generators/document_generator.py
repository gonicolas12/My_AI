...
class DocumentGenerator:
    ...
    async def generate_document(self, query: str, context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def generate_text(self, content: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Métadonnées
            full_content.append(f"Généré le: {datetime.now().strftime('%d/%m/%Y à %H:%M')}")
            full_content.append("")
    ...
    async def generate_report(self, data: Dict[str, Any], template: str = "default") -> Dict[str, Any]:
        """
